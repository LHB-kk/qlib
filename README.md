...
mkdir -p /root/qlib_data/cn_data
tar -zxvf qlib_bin.tar.gz -C /root/qlib_data/cn_data --strip-components=1
...
### Get with module
  ```bash
  # get 1d data
  python -m qlib.cli.data qlib_data --target_dir /root/qlib_data/cn_data --region cn

  # get 1min data
  python -m qlib.cli.data qlib_data --target_dir /root/qlib_data/cn_data_1min --region cn --interval 1min
...
- Run the initialization code and get stock data:
  ...
  # Initialization
  mount_path = "/root/qlib_data/cn_data"  # target_dir
...
3. At this point you are in the docker environment and can run the qlib scripts. An example:
    ```bash
    >>> python scripts/get_data.py qlib_data --name qlib_data_simple --target_dir /root/qlib_data/cn_data --interval 1d --region cn
