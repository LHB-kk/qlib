...
class GetData:
    ...
    def qlib_data(
        self,
        name="qlib_data",
        target_dir="/root/qlib_data/cn_data",
        version=None,
        interval="1d",
        region="cn",
        delete_old=True,
        ...
        ---------
        # get 1d data
        python get_data.py qlib_data --name qlib_data --target_dir /root/qlib_data/cn_data --interval 1d --region cn
        ...
        # get 1min data
        python get_data.py qlib_data --name qlib_data --target_dir /root/qlib_data/cn_data_1min --interval 1min --region cn
